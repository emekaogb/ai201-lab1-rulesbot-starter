...
```
The speed at which the chunks were ingested on the first time around was slower than I had expected. It took around 30 seconds. I can only imagine the latency with a much bigger vector store.
```
